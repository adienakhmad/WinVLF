...
namespace AwokeKnowing.GnuplotCSharp
{
    class GnuPlot
    {
        ...
        private static StreamReader GnupStRead;
        public static StreamReader GetImageStream { get { return GnupStRead; } }
        ...
        static GnuPlot()
        {
            ...
            /*ProcessStartInfo processStartInfo = new ProcessStartInfo(@"C:\Program Files (x86)\gnuplot\bin\gnuplot.exe");
            //new ProcessStartInfo(@"C:\Programme\gp460win32\binary\gnuplot.exe");
        ...
        public static void CallNew(string x86progamfiles)
        {
            PathToGnuplot = x86progamfiles;
            ProcessStartInfo processStartInfo = new ProcessStartInfo(PathToGnuplot);
            ...
            ExtPro = new Process();
            ExtPro.StartInfo = processStartInfo;

            ExtPro.Start();
            GnupStWr = ExtPro.StandardInput;
            GnupStRead = ExtPro.StandardOutput;
        ...
        public static void Plot(List<StoredPlot> storedPlots)
        {
            ...
            GnupStWr.WriteLine("bind Close \"exit gnuplot\"");
